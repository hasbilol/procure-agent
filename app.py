...
sys.path.insert(0, str(Path(__file__).parent / "procurement_agent"))

# Base path for procurement_agent directory
_PKG_DIR = Path(__file__).parent / "procurement_agent"
...
with tab_process:
    ...
    if uploaded_file is not None:
        temp_dir = _PKG_DIR / "temp_uploads"
...
with tab_generate:
    ...
    with col2:
        ...
        if st.button("Generate Invoice", type="primary", use_container_width=True):
            gen_dir = _PKG_DIR / "sample_invoices"
